...
public class PacketLogger : PluginInterface2 {
  ...
  internal PacketLogger(IntPtr cPtr, bool cMemoryOwn) : base(RakNetPINVOKE.CSharp_PacketLogger_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          RakNetPINVOKE.CSharp_delete_PacketLogger(swigCPtr);
        }
  ...
  public static PacketLogger GetInstance() {
    IntPtr cPtr = RakNetPINVOKE.CSharp_PacketLogger_GetInstance();
    PacketLogger ret = (cPtr == IntPtr.Zero) ? null : new PacketLogger(cPtr, false);
    return ret;
  }

  public static void DestroyInstance(PacketLogger i) {
    RakNetPINVOKE.CSharp_PacketLogger_DestroyInstance(PacketLogger.getCPtr(i));
  }

  public PacketLogger() : this(RakNetPINVOKE.CSharp_new_PacketLogger(), true) {
  }
  ...
  public override void OnReliabilityLayerNotification(string errorMessage, uint bitsUsed, SystemAddress remoteSystemAddress, bool isError) {
    RakNetPINVOKE.CSharp_PacketLogger_OnReliabilityLayerNotification(swigCPtr, errorMessage, bitsUsed, SystemAddress.getCPtr(remoteSystemAddress), isError);
    if (RakNetPINVOKE.SWIGPendingException.Pending) throw RakNetPINVOKE.SWIGPendingException.Retrieve();
  }

  public virtual void LogHeader() {
    RakNetPINVOKE.CSharp_PacketLogger_LogHeader(swigCPtr);
  }

  public virtual void WriteLog(string str) {
    RakNetPINVOKE.CSharp_PacketLogger_WriteLog(swigCPtr, str);
  }

  public virtual void WriteMiscellaneous(string type, string msg) {
    RakNetPINVOKE.CSharp_PacketLogger_WriteMiscellaneous(swigCPtr, type, msg);
  }

  public virtual void SetPrintID(bool print) {
    RakNetPINVOKE.CSharp_PacketLogger_SetPrintID(swigCPtr, print);
  }

  public virtual void SetPrintAcks(bool print) {
    RakNetPINVOKE.CSharp_PacketLogger_SetPrintAcks(swigCPtr, print);
  }

  public virtual void SetPrefix(string _prefix) {
    RakNetPINVOKE.CSharp_PacketLogger_SetPrefix(swigCPtr, _prefix);
  }

  public virtual void SetSuffix(string _suffix) {
    RakNetPINVOKE.CSharp_PacketLogger_SetSuffix(swigCPtr, _suffix);
  }

  public static string BaseIDTOString(byte Id) {
    string ret = RakNetPINVOKE.CSharp_PacketLogger_BaseIDTOString(Id);
    return ret;
  }

  public void SetLogDirectMessages(bool send) {
    RakNetPINVOKE.CSharp_PacketLogger_SetLogDirectMessages(swigCPtr, send);
  }
  ...
  private string FormatLineHelper(string into, string dir, string type, uint packet, uint frame, byte messageIdentifier, uint bitLen, ulong time, SystemAddress local, SystemAddress remote, uint splitPacketId, uint splitPacketIndex, uint splitPacketCount, uint orderingIndex) {
    string ret = RakNetPINVOKE.CSharp_PacketLogger_FormatLineHelper__SWIG_0(swigCPtr, into, dir, type, packet, frame, messageIdentifier, bitLen, time, SystemAddress.getCPtr(local), SystemAddress.getCPtr(remote), splitPacketId, splitPacketIndex, splitPacketCount, orderingIndex);
    if (RakNetPINVOKE.SWIGPendingException.Pending) throw RakNetPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  private string FormatLineHelper(string into, string dir, string type, uint packet, uint frame, string idToPrint, uint bitLen, ulong time, SystemAddress local, SystemAddress remote, uint splitPacketId, uint splitPacketIndex, uint splitPacketCount, uint orderingIndex) {
    string ret = RakNetPINVOKE.CSharp_PacketLogger_FormatLineHelper__SWIG_1(swigCPtr, into, dir, type, packet, frame, idToPrint, bitLen, time, SystemAddress.getCPtr(local), SystemAddress.getCPtr(remote), splitPacketId, splitPacketIndex, splitPacketCount, orderingIndex);
    if (RakNetPINVOKE.SWIGPendingException.Pending) throw RakNetPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
