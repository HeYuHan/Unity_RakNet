...
public class Router2 : PluginInterface2 {
  ...
  internal Router2(IntPtr cPtr, bool cMemoryOwn) : base(RakNetPINVOKE.CSharp_Router2_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          RakNetPINVOKE.CSharp_delete_Router2(swigCPtr);
        }
  ...
  public static Router2 GetInstance() {
    IntPtr cPtr = RakNetPINVOKE.CSharp_Router2_GetInstance();
    Router2 ret = (cPtr == IntPtr.Zero) ? null : new Router2(cPtr, false);
    return ret;
  }

  public static void DestroyInstance(Router2 i) {
    RakNetPINVOKE.CSharp_Router2_DestroyInstance(Router2.getCPtr(i));
  }

  public Router2() : this(RakNetPINVOKE.CSharp_new_Router2(), true) {
  }

  public void SetSocketFamily(ushort _socketFamily) {
    RakNetPINVOKE.CSharp_Router2_SetSocketFamily(swigCPtr, _socketFamily);
  }

  public void EstablishRouting(RakNetGUID endpointGuid) {
    RakNetPINVOKE.CSharp_Router2_EstablishRouting(swigCPtr, RakNetGUID.getCPtr(endpointGuid));
    if (RakNetPINVOKE.SWIGPendingException.Pending) throw RakNetPINVOKE.SWIGPendingException.Retrieve();
  }

  public void SetMaximumForwardingRequests(int max) {
    RakNetPINVOKE.CSharp_Router2_SetMaximumForwardingRequests(swigCPtr, max);
  }

  public void SetDebugInterface(Router2DebugInterface _debugInterface) {
    RakNetPINVOKE.CSharp_Router2_SetDebugInterface(swigCPtr, Router2DebugInterface.getCPtr(_debugInterface));
  }

  public Router2DebugInterface GetDebugInterface() {
    IntPtr cPtr = RakNetPINVOKE.CSharp_Router2_GetDebugInterface(swigCPtr);
