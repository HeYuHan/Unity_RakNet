...
public class FileListTransfer : PluginInterface2 {
  ...
  internal FileListTransfer(IntPtr cPtr, bool cMemoryOwn) : base(RakNetPINVOKE.CSharp_FileListTransfer_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          RakNetPINVOKE.CSharp_delete_FileListTransfer(swigCPtr);
        }
  ...
  public static FileListTransfer GetInstance() {
    IntPtr cPtr = RakNetPINVOKE.CSharp_FileListTransfer_GetInstance();
  ...
  public static void DestroyInstance(FileListTransfer i) {
    RakNetPINVOKE.CSharp_FileListTransfer_DestroyInstance(FileListTransfer.getCPtr(i));
  }

  public FileListTransfer() : this(RakNetPINVOKE.CSharp_new_FileListTransfer(), true) {
  }

  public void StartIncrementalReadThreads(int numThreads, int threadPriority) {
    RakNetPINVOKE.CSharp_FileListTransfer_StartIncrementalReadThreads__SWIG_0(swigCPtr, numThreads, threadPriority);
  }

  public void StartIncrementalReadThreads(int numThreads) {
    RakNetPINVOKE.CSharp_FileListTransfer_StartIncrementalReadThreads__SWIG_1(swigCPtr, numThreads);
  }
  ...
  public void Send(FileList fileList, RakPeerInterface rakPeer, SystemAddress recipient, ushort setID, PacketPriority priority, char orderingChannel) {
    RakNetPINVOKE.CSharp_FileListTransfer_Send__SWIG_2(swigCPtr, FileList.getCPtr(fileList), RakPeerInterface.getCPtr(rakPeer), SystemAddress.getCPtr(recipient), setID, (int)priority, orderingChannel);
    if (RakNetPINVOKE.SWIGPendingException.Pending) throw RakNetPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void CancelReceive(ushort setId) {
    RakNetPINVOKE.CSharp_FileListTransfer_CancelReceive(swigCPtr, setId);
  }

  public void RemoveReceiver(SystemAddress systemAddress) {
    RakNetPINVOKE.CSharp_FileListTransfer_RemoveReceiver(swigCPtr, SystemAddress.getCPtr(systemAddress));
    if (RakNetPINVOKE.SWIGPendingException.Pending) throw RakNetPINVOKE.SWIGPendingException.Retrieve();
  }

  public bool IsHandlerActive(ushort setId) {
    bool ret = RakNetPINVOKE.CSharp_FileListTransfer_IsHandlerActive(swigCPtr, setId);
    return ret;
  }

  public void AddCallback(FileListProgress cb) {
    RakNetPINVOKE.CSharp_FileListTransfer_AddCallback(swigCPtr, FileListProgress.getCPtr(cb));
  }
  ...
  public void ClearCallbacks() {
    RakNetPINVOKE.CSharp_FileListTransfer_ClearCallbacks(swigCPtr);
  }
